...
> **Nota fechada 9-sep-2026 (corrida 12, bloque 2.6):** este artefacto se produjo con 10.000 réplicas del bootstrap de día. Desde el 9-sep `GEMELO/bifurcaciones.py` importa el número de réplicas del árbitro (`cifras.N_BOOT_DIA` = 4.000, el que produce las cifras publicadas), así que el comando de abajo ya NO reproduce este archivo con 10.000: lo regenera con 4.000 y el último decimal de algún IC de día puede diferir (medido en el ancla: [−7,2, +26,6] con 4.000 contra [−7,2, +26,5] con 10.000; los dos contienen el cero). El artefacto no se regeneró en la corrida 12; queda declarado.
