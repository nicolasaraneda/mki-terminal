...
def informe(r: dict) -> str:
    ...
    L += ["## ⚠ El Sharpe de estas tablas NO es capturable", "",
          ...
          "DSR se reportan como **NO INTERPRETABLE**. (Errata 2-sep-2026: la",
          "versión anterior de este aviso hablaba de «saturación en 1.0000 por",
          "anualizar un Sharpe sobre pocos días»; era el defecto de unidades del",
          "PSR/DSR, corregido en `control_lineal.inferencia_sharpe`; la razón",
          "vigente está en el comentario de `MINIMO_DIAS_SHARPE`.)", "",
